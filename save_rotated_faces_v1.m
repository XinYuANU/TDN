...
h5create('YTC_HR_rotate_v1.hdf5','/YTC',[128 128 3 num_data]);
h5disp('YTC_HR_rotate_v1.hdf5');
h5write('YTC_HR_rotate_v1.hdf5','/YTC',data_HR);
...
h5create('YTC_LR_rotate_v1.hdf5','/YTC',[16 16 3 num_data]);
h5disp('YTC_LR_rotate_v1.hdf5');
h5write('YTC_LR_rotate_v1.hdf5','/YTC',data_LR);
...
%% read hdf5
Data = h5read('YTC_LR_rotate_v1.hdf5','/YTC');
